    ...
    <div class="justify-content-center">
        ...
        <div class="card card-teal">
            <div class="card-header">
                ...
                <h1 class="card-title col-md-7"><b>بيانات الجدول اليومي</b></h1>
            ...
            <!-- /.card-header -->
            <form method="Post" action="{{ route('daily.add', ['yearname' => $year->name]) }}"
